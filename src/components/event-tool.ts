...
export enum EditorEvents {
  ...
  editorZoominout = "editorZoominout",
  editorRedo = "editorRedo",
  editorUndoRedoable = "editorUndoRedoable",
  editorUpdateCurrentTime = "editorUpdateCurrentTime",
  editorUpdateDuration = "editorUpdateDuration",
  itemSelected = "itemSelected",
  cutable = "cutable",
  setBgColor = "setBgColor",
  setBgUrl = "setBgUrl",
  editorLoading = "editorLoading",
  editorScreenIsEmpty = "editorScreenIsEmpty",
  editorCut = "editorCut",
  ...
  exportElementAttribution = "exportElementAttribution",
  updateElement = "updateElement",
  updateTimeline = "updateTimeline",
  updateTimelineReverse = "updateTimelineReverse",
  redrawMonitor = "redrawMonitor",
  redrawTimeline = "redrawTimeline",
  handleSelectItem = "handleSelectItem",
  timelineHandleSelectItem = "timelineHandleSelectItem",
  clearMonitorSelectItem = "clearMonitorSelectItem",
  clearTimelineSelectItem = "clearTimelineSelectItem",
  monitorDuplicateElement = "monitorDuplicateElement",
  delElement = "delElement",
  delElementCallback = "delElementCallback",
  exportProjJson = "exportProjJson",
...
export const editorEventBus = new EventTool();
